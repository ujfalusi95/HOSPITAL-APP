<html lang="en">
  <head>
    ...
    <link href="public/custom/css/portada.css" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <nav class="site-header sticky-top py-1">
      <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-2 d-none d-md-inline-block" href="MostrarPaciente.jsp">PACIENTES</a>
        <a class="py-2 d-none d-md-inline-block" href="MostrarMedicos.jsp">MEDICOS</a>
        <a class="py-2 d-none d-md-inline-block" href="MostrarIngresos.jsp">INGRESOS</a>
